...
namespace BusinessLogicLayer
{
  public  class EmployeeBusiness : IDisposable
    {
        private readonly EmployeeManagementEntities dbcontext;
        public bool status;
        public EmployeeBusiness(EmployeeManagementEntities dbcontext)
        {
        ...
        {
            using (DataAccessLayer.EmployeeManagementEntities db = new EmployeeManagementEntities())
            {
